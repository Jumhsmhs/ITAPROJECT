                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="mitr-light text-dark" style="font-family: 'Mitr', sans-serif; font-weight: 400;">
                                        1. มีประกาศเจตนารมณ์เป็นหน่วยงานที่เจ้าหน้าที่ของรัฐทุกคนไม่รับของขวัญ และของกำนัลทุกชนิดจากการปฏิบัติหน้าที่ (No Gift Policy) ของปีงบประมาณ พ.ศ. 2568 ที่มีลักษณะเป็น Infographic No Gift Policy ในนามหัวหน้าหน่วยงานอยู่หน้าเว็บไซต์หลักของหน่วยงาน
                                    </td>
                                    <?php
                                    $selected_year = isset($_SESSION['budget_year']) ? $_SESSION['budget_year'] : '2569';
                                    $target_id = $selected_year . '0128';
                                    ?>
                                ...
                                <tr>
                                    <td class="mitr-light text-dark" style="font-family: 'Mitr', sans-serif; font-weight: 400;">
                                        2. มีบันทึกข้อความ ที่ผู้บริหารลงนามในคำสั่ง หรือประกาศ หรือข้อสั่งการ และมีการขออนุญาตนำเผยแพร่บนเว็บไซต์ของหน่วยงาน
                                    <?php
                                    $selected_year = isset($_SESSION['budget_year']) ? $_SESSION['budget_year'] : '2569';
                                    $target_id = $selected_year . '0129';
                                    ?>
                                    <td class="text-center">
                                        <?php if (!empty($docData[$target_id]) && !empty($docData[$target_id]['file_pdf'])): ?>
                                            <a
                                ...
                                <tr>
                                    <td class="mitr-light text-dark" style="font-family: 'Mitr', sans-serif; font-weight: 400;">
                                        3. มีคำสั่ง หรือประกาศ หรือข้อสั่งการ มาตรการการป้องกันการรับสินบนทุกรูปแบบและระบุการกำหนดกลไกการกำกับติดตาม ของปีงบประมาณ พ.ศ. 2568 ตามข้อมูลประกอบข้อคำถาม ประเด็นข้อ 1. ถึงข้อ 5. ตามที่หน่วยงานกำหนด
                                    </td>
                                    <?php
                                    $selected_year = isset($_SESSION['budget_year']) ? $_SESSION['budget_year'] : '2569';
                                    $target_id = $selected_year . '0130';
                                    ?>
                                    <td class="text-center">
                                        <?php if (!empty($docData[$target_id]) && !empty($docData[$target_id]['file_pdf'])): ?>
                                            <a
                                ...
                                <tr>
                                    <td class="mitr-light text-dark" style="font-family: 'Mitr', sans-serif; font-weight: 400;">
                                        5. มีแบบฟอร์มการเผยแพร่ข้อมูลต่อสาธารณะผ่านเว็บไซต์ของหน่วยงาน </td>
                                    <?php
                                    $selected_year = isset($_SESSION['budget_year']) ? $_SESSION['budget_year'] : '2569';
                                    $target_id = $selected_year . '0132';
                                    ?>
                                    <td class="text-center">
                                        <?php if (!empty($docData[$target_id]) && !empty($docData[$target_id]['file_pdf'])): ?>
                                            <a
                                ...
                                <tr>
                                    <td class="mitr-light text-dark" style="font-family: 'Mitr', sans-serif; font-weight: 400;">
                                        2. มีรายงานสรุปผลการกำกับติดตามมาตรการการป้องกันการรับสินบนทุกรูปแบบ ประเด็นข้อ 1. ถึงข้อ 5. (แนบตามข้อ 1.)
                                    </td>
                                    <?php
                                    $selected_year = isset($_SESSION['budget_year']) ? $_SESSION['budget_year'] : '2569';
                                    $target_id = $selected_year . '0134';
                                    ?>
                                    <td class="text-center">
                                        <?php if (!empty($docData[$target_id]) && !empty($docData[$target_id]['file_pdf'])): ?>
                                            <a
