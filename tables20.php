                            ...
                            <tbody>
                                <tr>
                                    <td class="mitr-light text-dark" style="font-family: 'Mitr', sans-serif; font-weight: 400;" colspan="3">
                                        1. มีหลักฐานโครงการอบรมเรื่องผลประโยชน์ทับซ้อนโดยใช้หลักสูตรต้านทุจริตศึกษา (Anti-Corruption Education) กระทรวงสาธารณสุข ภายใต้พันธสัญญา : สาธารณสุข ซื่อสัตย์ โปร่งใส ตื่นรู้ สู้ทุจริต จิตพอเพียง ประจำปีงบประมาณ พ.ศ. 2568
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        1.2 โครงการและมีการขออนุญาตนำไปเผยแพร่บนเว็บไซต์ของหน่วยงาน
                                    </td>
                                    <?php
                                    $selected_year = isset($_SESSION['budget_year']) ? $_SESSION['budget_year'] : '2569';
                                    $target_id = $selected_year . '0176';
                                    ?>
                                    <td class="text-center">
                                        <?php if (!empty($docData[$target_id]) && !empty($docData[$target_id]['file_pdf'])): ?>
                                            <a
                                ...
                                <tr>
                                    <td class="mitr-light text-dark" style="font-family: 'Mitr', sans-serif; font-weight: 400;">
                                        3. มีรายงานผลการอบรมเรื่องผลประโยชน์ทับซ้อนโดยใช้หลักสูตรต้านทุจริตศึกษา (Anti-Corruption Education) กระทรวงสาธารณสุข ภายใต้พันธสัญญา : สาธารณสุข ซื่อสัตย์ โปร่งใส ตื่นรู้ สู้ทุจริต จิตพอเพียง ประจำปีงบประมาณ พ.ศ. 2568
                                    </td>
                                    <?php
                                    $selected_year = isset($_SESSION['budget_year']) ? $_SESSION['budget_year'] : '2569';
                                    $target_id = $selected_year . '0178';
                                    ?>
                                    <td class="text-center">
                                        <?php if (!empty($docData[$target_id]) && !empty($docData[$target_id]['file_pdf'])): ?>
                                            <a
