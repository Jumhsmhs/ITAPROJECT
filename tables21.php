                    ...
                    <div class="row m-4">
                        <table class="table table-bordered bg-white ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="mitr-light text-dark" style="font-family: 'Mitr', sans-serif; font-weight: 400;">
                                        3. มีกิจกรรมประกาศเจตนารมณ์ตามข้อ 1.1 ถึงข้อ 1.3 ของหน่วยงาน ต่อสาธารณชน ดำเนินกิจกรรมประกาศในวันเดียวกัน (ระยะเวลาตั้งแต่เดือนตุลาคม 2567 ถึงเดือนมีนาคม 2568)
                                    </td>
                                    <?php
                                    $selected_year = isset($_SESSION['budget_year']) ? $_SESSION['budget_year'] : '2569';
                                    $target_id = $selected_year . '0183';
                                    ?>
                                    <td class="text-center">
                                        <?php if (!empty($docData[$target_id]) && !empty($docData[$target_id]['file_pdf'])): ?>
                                            <a
